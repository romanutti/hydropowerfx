...
public class ImageControl extends Region {
    ...
    private void initializeParts() {
        ...
        Image waterImage = new Image("/images/empty_icon.png");
    ...
    public void setWaterImageView(ImageView waterImageView) {
        this.waterImageView = waterImageView;
    }

    public void setImage(Image image){
        this.waterImageView.setImage(image);
    }
}
